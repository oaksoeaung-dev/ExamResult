        ...
        <div class="px-10 py-28">
            ...
            <form method="POST" action="{{ route("login") }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password" type="password" name="password" :value="old('password')" :messages="$errors->get('password')" icon="fi fi-rr-lock" placeholder="" />
                </div>
                ...
                <div class="mt-4 flex items-center justify-end">
                    <a class="rounded-md text-sm text-zinc-600 underline hover:text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2" href="{{ route("register") }}">
                        {{ __("Register here!") }}
                    </a>
