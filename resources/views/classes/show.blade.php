...
<x-app-layout>
    <div class="space-y-5">
        <div class="max-w-xl mx-auto md:mx-0 lg:mx-0 bg-white border border-gray-200 rounded-lg shadow-xl overflow-hidden">
            <a href="#">
            ...
            <div class="p-5 space-y-4 bg-gray-50">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('classes.index') }}" class="btn-outline-gray w-full">Back</a>
                    <a href="{{ route('classes.edit',$class->id) }}" class="btn-gray w-full">Edit</a>
                </div>
            </div>
        </div>
    </div>
