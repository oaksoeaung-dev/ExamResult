...
<x-app-layout>
    <div class="space-y-5">
        <div class="mx-auto max-w-xl overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-xl md:mx-0 lg:mx-0">
            <a href="#">
                <img class="h-[300px] w-full rounded-t-lg object-cover" src="{{ asset("images/background/" . rand(1, 8) . ".png") }}" alt="" />
            </a>
