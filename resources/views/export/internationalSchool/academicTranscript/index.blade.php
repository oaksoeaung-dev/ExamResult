            ...
            <form action="{{ route("export.internationalSchool.academicTranscript.generate") }}" method="post" enctype="multipart/form-data" class="mt-5 space-y-5">
                ...
                <div>
                    <div class="flex">
                        ...
                        <a href="{{ route("export.internationalSchool.download", "GraduationExample.csv") }}" class="flex w-52 items-center justify-center gap-3 rounded-r-lg border-y border-r border-zinc-200 bg-zinc-50 py-2 text-sm hover:bg-zinc-100 peer-focus:border-zinc-500">
