<x-app-layout>
    <div class="space-y-10">
        <div class="space-y-8">
            ...
            <h2 class="text-3xl">Government Report Card</h2>
        </div>
        <div class="max-w-2xl rounded-lg border p-5 shadow">
            ...
            <form action="{{ route("export.internationalSchool.reportCard.government.generate") }}" method="post" enctype="multipart/form-data" class="mt-5 space-y-5">
                @csrf
                <div>
                    <div class="flex">
                        ...
                        <a href="{{ route("export.internationalSchool.download", "gov_example.csv") }}" class="flex w-52 items-center justify-center gap-3 rounded-r-lg border-y border-r border-gray-200 bg-gray-50 py-2 text-sm hover:bg-gray-100 peer-focus:border-gray-500">
