            ...
            <div class="mt-10 grid h-full grid-cols-3 gap-5">
                ...
                <div class="space-y-5">
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                        ...
                        <div class="mt-5 space-y-5">
                            <x-text-input2 name="past_medical_history" :value="old('past_medical_history')">
                                Past Medical History
                            </x-text-input2>
                            <x-text-input2 name="family_history" :value="old('family_history')">
                                Family History
                            </x-text-input2>
                            <x-text-input2 name="past_surgical_history" :value="old('past_surgical_history')">
                                Past Surgical History
                            </x-text-input2>
                            <x-text-input2 name="current_medication" :value="old('current_medication')">
                                Current Medication
                            </x-text-input2>
                            <x-text-input2
                    ...
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                        ...
                        <div class="mt-5 space-y-5">
                            ...
                            <x-text-input2 name="teeth_and_gum" :value="old('teeth_and_gum')">
                                Teeth And Gum
                            </x-text-input2>
                            <div class="">
                            ...
                            <div class="">
                                ...
                                >
                                    ...
                                    @foreach ($doctorsigns as $doctorsign)
                                        <option
                                            value="{{ $doctorsign->slug }}"
                                            {{ old("sign") == $doctorsign->slug ? "selected" : "" }}
                                        >
                                            {{ $doctorsign->name }}
                                        </option>
                                    @endforeach
