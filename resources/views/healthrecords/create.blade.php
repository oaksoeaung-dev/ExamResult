                    ...
                    <div class="bg-zinc-50 p-5 shadow-lg rounded-lg h-fit">
                        ...
                        <div class="mt-5 space-y-5">
                            ...
                            <div class="">
                                ...
                                <textarea type="text" id="mouth_remark" name="mouth_remark" class="bg-zinc-50 border border-zinc-300 text-zinc-700 text-sm rounded-lg focus:ring-zinc-500 focus:border-zinc-500 block w-full p-2.5 focus:outline-none" placeholder="" >{{ old('mouth_remark') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="bg-zinc-50 p-5 shadow-lg rounded-lg h-fit">
                    ...
                    <div class="bg-zinc-50 p-5 shadow-lg rounded-lg h-fit">
                        ...
                        <div class="mt-5 space-y-5">
                            ...
                            <div class="">
                                ...
                                <textarea type="text" id="body_remark" name="body_remark" class="bg-zinc-50 border border-zinc-300 text-zinc-700 text-sm rounded-lg focus:ring-zinc-500 focus:border-zinc-500 block w-full p-2.5 focus:outline-none" placeholder="" >{{ old('body_remark') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="bg-zinc-50 p-5 shadow-lg rounded-lg h-fit">
                            ...
                            <div class="">
                                ...
                                <select id="sign" name="sign" class="bg-zinc-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-zinc-500 focus:outline-none focus:border-zinc-500 block w-full p-2.5">
                                    ...
                                    @foreach($doctorsigns as $doctorsign)
                                        <option value="{{$doctorsign->slug}}" {{ old('sign') == $doctorsign->slug ? "selected" : "" }}>{{ $doctorsign->name }}</option>
                                    @endforeach
                                </select>
                                @error('sign')
