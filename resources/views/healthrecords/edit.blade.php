                    ...
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                        ...
                        <div class="mt-5 space-y-5">
                            ...
                            <div class="">
                                ...
                                <textarea type="text" id="mouth_remark" name="mouth_remark" class="block w-full rounded-lg border border-zinc-300 bg-zinc-50 p-2.5 text-sm text-zinc-700 focus:border-zinc-500 focus:outline-none focus:ring-zinc-500" placeholder="">{{ old("mouth_remark", $record->mouth->remark) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                    ...
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                        ...
                        <div class="mt-5 space-y-5">
                            ...
                            <div class="">
                                ...
                                <textarea type="text" id="body_remark" name="body_remark" class="block w-full rounded-lg border border-zinc-300 bg-zinc-50 p-2.5 text-sm text-zinc-700 focus:border-zinc-500 focus:outline-none focus:ring-zinc-500" placeholder="">{{ old("body_remark", $record->bodystatus->remark) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="h-fit rounded-lg bg-zinc-50 p-5 shadow-lg">
                            ...
                            <div class="">
                                ...
                                <select id="sign" name="sign" class="block w-full rounded-lg border border-gray-300 bg-zinc-50 p-2.5 text-sm text-gray-900 focus:border-zinc-500 focus:outline-none focus:ring-zinc-500">
                                    ...
                                    @foreach ($doctorsigns as $docsign)
                                        <option value="{{ $docsign->slug }}" {{ old("sign", $record->doctorsign->sign) == $docsign->slug ? "selected" : "" }}>
                                            {{ $docsign->name }}
                                        </option>
                                    @endforeach
                                </select>
