                    ...
                    <div class="">
                        ...
                        <div id="image-preview" class="max-w-sm p-6 bg-gray-50 rounded-lg items-center mx-auto text-center cursor-pointer">
                            <label for="upload" class="cursor-pointer">
                                ...
                                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload student photo</h5>
            ...
            <div>
                ...
                <div class="flex gap-5 items-center">
                    <div class="flex gap-2 items-center">
                        <input id="male" type="radio" value="male" name="gender" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
