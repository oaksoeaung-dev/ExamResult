<x-app-layout>
    <div class="space-y-10 text-sm">
        <div>
            <h1 class="flex gap-2 items-center"><i class="fi fi-rr-document"></i><span>Upload Transcript</span></h1>
        </div>
        <p>Graduation အတွက်သုံးရန်ဖြစ်သည်။</p>
        <ul class="list-disc ps-5 space-y-3">
            <li class="">Download example CSV <a href="{{ route("export.international-school.download","GraduationExample.csv") }}" class="text-sky-500">here</a>.</li>
            <li>
            ...
            <li>
                <span class="badge-sky">Main Subjects.</span> ပါသော column header များကို ဖျက်လို့ရပါတယ်။ ပြင်လို့တော့မရပါ။ <span class="font-semibold">Absent</span> ဖြစ်တဲ့ကလေးများအတွက် <span class="badge-violet">-</span> ထည့်လို့ရပါတယ်။ အမှတ်တန်းထည့်လည်းရပါတယ်။ A,B,C,D,E,F ထည့်လည်းရပါတယ်။
            </li>
            <li>
                <span class="badge-green">Remark</span> column တွင် စာတိုတာကပိုအဆင်ပြေပါတယ်
            </li>
            <li>
                <span class="badge-green">Class Teacher Sign</span> column နှင့် <span class="badge-green">Dean Sign</span> column နှစ်ခုမှာ teacher list ထဲမှ <span class="badge-yellow">keyword</span> ကိုထည့်ပေးရမည်။ <span class="badge-yellow">keyword</span> မရှိလျှင် create ကိုနှိပ်ပြီးထည့်နိုင်ပါတယ်။
            </li>
            <li>
                <span class="badge-green">Division</span> column သည် <span class="font-semibold">Dean</span> များအတွက်ဖြစ်ပါတယ်။ Lower primary dean အတွက် <span class="badge-violet">lower</span> upper primary dean အတွက် <span class="badge-violet">upper</span> secondary dean အတွက် <span class="badge-violet">secondary</span> လို့ထည့်ပေးရပါမယ်။
            </li>
        </ul>
    </div>
</x-app-layout>
