<x-app-layout>
    <form action="{{ route("users.update", $user->id) }}" method="POST" class="w-1/3 space-y-10">
        ...
        <div>
            <select id="" name="role_id" class="mb-6 block w-full rounded-lg border border-zinc-300 bg-zinc-50 p-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-300 focus:ring-offset-1">
